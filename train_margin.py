...
# MODEL & LOSS FUNCTION
# =============================================================================
model, our_loss = init_model_and_loss(options, cuda=cuda_available, margin_loss=True)
print(model)
...
for epoch in range(options.epochs):
    ...
    for i, (data, setname, _, _) in enumerate(dataloader, 1):
        ...
        print('[%4d/%4d][%3d/%3d] Margin:%.3f %s \tTotal time elapsed: %s'
              % (epoch+1, options.epochs, i, len(dataloader), margin, util.get_loss_string(loss_detail),
